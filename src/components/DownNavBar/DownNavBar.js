            ...
            <ul className="nav">
                <li className="nav-item">
                    <a className="nav-link active" aria-current="page" href="/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-amd" viewBox="0 0 16 16">
                ...
                <li className="nav-item">
                    <a className="nav-link" href="/community">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-collection" viewBox="0 0 16 16">
